...
1. Clone o repositório do Projeto [Blog Pessoal](https://github.com/luizaeg/blogpessoal_spring) dentro da pasta do *Workspace* do STS
 
```bash
git clone https://github.com/luizaeg/blogpessoal_spring.git
```
